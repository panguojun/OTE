...
protected:
	IDirect3DDevice9*		mpDevice;			// D3D设备
	IDirect3DTexture9*		mpTexture;			// 字形纹理
...
public:
	IDirect3DTexture9* GetGlyphTexture( );							// 得到字形纹理，pText是多字节，指向一个字符
...
protected:
	std::vector< IDirect3DTexture9* >	mFontTex;			// 字符纹理
