...
class CMeshEditorDlg : public CDialog
{
	DECLARE_DYNAMIC(CMeshEditorDlg)

public:
	CMeshEditorDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CMeshEditorDlg();

// 对话框数据
	enum { IDD = IDD_EntEditMain };
public:
	static	CMeshEditorDlg		s_Inst;
